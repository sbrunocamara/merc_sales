 ...
 * @author bsbru
 */
public class ItemsCompraListaAdd extends javax.swing.JFrame {
     ...
     */
    public ItemsCompraListaAdd(ArrayList<ProdutoClasse> produtos, CompraClasse compra) {
...
//        System.out.println(jTableFornecedores.getModel().getValueAt(jTableFornecedores.getSelectedRow(), 0));
    ...
    private void SelecionarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SelecionarMouseClicked
        ...
        produto.setId(codProduto);
        produto.setDescricao(descricao);
        produto.setValor_unitario(valorUn);
//
        ...
        itemCompraAdd itemCompraAdd = new itemCompraAdd(produto,this.compras);
        itemCompraAdd.setVisible(true);
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ItemsCompraListaAdd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
